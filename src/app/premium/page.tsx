...
import { blogPosts, newsItems } from '@/data/premium';
...
export default function PremiumHomePage() {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <ScrollAnimation>
            <div className="text-center mb-16">
              ...
              >
                LATEST <span className="text-[#DC143C]">BLOG</span>
              </motion.h2>
              <div className="w-24 h-1 bg-[#FFD700] mx-auto mb-4"></div>
              <p className="text-gray-300 text-lg">最新のブログ記事</p>
            </div>
          </ScrollAnimation>
            ...
            {latestBlogs.map((post, index) => (
              <ScrollAnimation key={post.id} delay={index * 0.1}>
                <Link href={`/premium/blog/${post.id}`}>
                  <motion.article
                    whileHover={{ y: -10, boxShadow: '0 20px 40px rgba(220, 20, 60, 0.3)' }}
                    className="bg-[#2a2a2a] rounded-lg overflow-hidden shadow-xl transition-all cursor-pointer"
                  >
                    ...
                    <div className="p-6">
                      ...
                      <div className="mt-4 text-[#DC143C] font-semibold text-sm">
                        続きを読む →
                      </div>
                    </div>
                  </motion.article>
      ...
      {/* News & Informationセクション (Premium限定) */}
      <section className="py-20 bg-[#0f0f0f]">
        <div className="container mx-auto px-4">
          <ScrollAnimation>
            <div className="text-center mb-16">
              ...
              >
                NEWS & <span className="text-[#DC143C]">INFORMATION</span>
              </motion.h2>
              <div className="w-24 h-1 bg-[#FFD700] mx-auto mb-4"></div>
              <p className="text-gray-300 text-lg">最新のお知らせ</p>
            </div>
          </ScrollAnimation>

          <ScrollAnimation delay={0.2}>
            <div className="max-w-4xl mx-auto">
              <div className="bg-[#2a2a2a] rounded-lg border-2 border-[#DC143C] overflow-hidden shadow-xl">
                {latestNews.map((news, index) => (
                  <Link key={news.id} href={`/premium/news/${news.id}`}>
                    <motion.div
                      whileHover={{ backgroundColor: '#333' }}
                      className={`p-6 transition-colors cursor-pointer ${
                        index !== latestNews.length - 1 ? 'border-b border-gray-600' : ''
                      }`}
                    >
                      <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                        ...
                        <div className="flex-1">
                          <h3 className="text-white font-semibold hover:text-[#DC143C] transition-colors">
                            {news.title}
                          </h3>
                        </div>
                      </div>
